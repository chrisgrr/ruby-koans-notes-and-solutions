...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # When no target for the operator is specified
  ...
  # As many occurances as possible are matched. They eat all the things.
  ...
  def test_slash_b_anchors_to_a_word_boundary
    ...
    # /b anchors to the start of a word containing vine and .
    # increases the boundary by a single character.
  end
  ...
  def test_parentheses_also_capture_matched_content_by_number
    ...
    # Each set of parentheses are a capture group referenced by
    # the number following the regexp.
  end
  ...
  # A character class will match a single character, but an alternation
