...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject combines the elements of the array by creating a memo
    # value which is updated on each iteration to the value returned
    # by the block. The initial value of the memo can be specified
    # as inject's method argument.
  end
